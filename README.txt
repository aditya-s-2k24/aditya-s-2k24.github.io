...
- "page views" only apply to pages, so a VIEW type console.log is only generated when a user loads index.html or q3.html NOT when they click on an email, telephone or CV link.
